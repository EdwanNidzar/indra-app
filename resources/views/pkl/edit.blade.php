...
@section('judul_halaman', 'PKL | Edit Data')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Data PKL</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md">
                          ...
                          <div class="form-group">
                            ...
                            <select name="lama_pkl" id="lama_pkl" class="form-control">
                              <option value="2 Bulan" {{ $data->lama_pkl == '2 Bulan' ? 'selected' : '' }}>2 Bulan
                              </option>
                              <option value="3 Bulan" {{ $data->lama_pkl == '3 Bulan' ? 'selected' : '' }}>3 Bulan
                              </option>
                            </select>
                            @error('lama_pkl')
                              <div class="alert alert-danger mt-2">{{ $message }}</div>
