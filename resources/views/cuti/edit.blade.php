...
@section('judul_halaman', 'Pengajuan Cuti | Edit Data')
                        ...
                        <div class="col-md">
                          ...
                          <div class="form-group">
                            ...
                            <textarea name="alasan_cuti" id="alasan_cuti" class="form-control" cols="30" rows="5"
                              placeholder="Masukan Alasan Cuti">{{ $data->alasan_cuti }}</textarea>
                            @error('alasan_cuti')
                          ...
                          <div class="form-group">
                            ...
                            <input type="date" value="{{ $data->tanggal_mulai }}" name="tanggal_mulai"
                          ...
                          <div class="form-group">
                            ...
                            <input type="date" value="{{ $data->tanggal_mulai }}" name="tanggal_selesai"
