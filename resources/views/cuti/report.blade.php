...
<body>
  <section class="sheet">
    ...
    <h3 style="text-align: center; margin-top: 0px;">{{ $cuti->nomor_surat }}</h3>

    <div class="content">
      <p><b>Kepada Yth:
          <br>Kepala/pemimpin/dekan/ketua/apapun itu</b></p>
      <p>Dengan Hormat,</p>
      <p>Yang bertanda tangan di bawah ini:
        <br><b>{{ $cuti->name }}.</b>
      </p>

      <p>Bermaksud mengajukan cuti dengan alasan:
        <br><b style="text-decoration: underline;">"{{ $cuti->alasan_cuti }}"</b>

        <br>
        <br>Selama <b style="text-decoration: underline;">{{ $cuti->tanggal_mulai }} sampai
          {{ $cuti->tanggal_selesai }}</b>.
      </p>
