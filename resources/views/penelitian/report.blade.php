...
<body>
    <section class="sheet">
        ...
        <h3 style="text-align: center; margin-top: 0px;">{{ $penelitian->nomor_surat }}</h3>

        <div class="content">
            <p><b>Kepada Yth:
                    <br>{{ $penelitian->tempat_penelitian }}</b></p>
            <p>Dengan Hormat</p>
            <p>Sehubungan dengan rencana Penelitian Mahasiswa/i Sekolah Tinggi Ilmu Ekonomi Indonesia (STIE Indonesia) Banjarmasin dan sekaligus menjalin kemitraan antara pendidikan tinggi dengan berbagai Perusahaan pemakai Tenaga Kerja. Maka dimohon kiranya dapat Menerima kami untuk melaksanakan Penelitian.</p>
            <br>
            <p>Adapun Mahasiswa yang dimaksud adalah :
                <br><b>{{ $penelitian->name }}.</b></p>
            <br>
            <p>Waktu pelaksanaan Penelitian yang di harapkan bisa di mulai pada tanggal <b style="text-decoration: underline;">{{ $penelitian->tanggal_mulai }} sampai {{ $penelitian->tanggal_selesai }}</b> atau di sesuaikan dengan waktu yang di tentukan.</p>
