...
@section('judul_halaman', 'Izin Penelitian | Tambah Data')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tambah Data Penelitian</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-md">
                          ...
                          <div class="form-group">
                            <label for="tanggal_mulai">judul Penelitian</label>
                          ...
                          <div class="form-group">
                            <label for="tanggal_selesai">judul Penelitian</label>
