    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td class="text-center align-middle">{{ $countPenelitians }}</td>
        </tr>
        <tr>
          <td class="text-center align-middle">2</td>
          <td class="text-center align-middle">Surat PKL</td>
          <td class="text-center align-middle">{{ $countPkls }}</td>
        </tr>
        <tr>
          <td class="text-center align-middle">3</td>
          <td class="text-center align-middle">Surat Mahasiswa Aktif</td>
          <td class="text-center align-middle">{{ $countMahasiswaAktifs }}</td>
        </tr>
      </tbody>
    </table>
