...
@section('judul_halaman', 'Mahasiswa Aktif | Edit Data')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Data Mahasiswa Aktif</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md">
                          <div class="form-group">
                            ...
                            <textarea name="tujuan_surat" id="tujuan_surat" class="form-control" cols="30" rows="10"
                              placeholder="Masukkan Tujuan Pengajuan Surat">{{ $data->tujuan_surat }}</textarea>
                            @error('tujuan_surat')
